...
| FLAG-001 | Flag Security | Zero flag or flag_hash leakage in public challenge APIs (Section 21) | **PASS** | `CRITICAL` | Flag string found in payload: false. Payload excerpt: {"success":true,"data":{"id":"f1b72220-4edb-4ad3-9be0-5a63b66ab3be","category_id":"11111111-1111-111... | N/A (Working as intended) |
...
| UPLOAD-001 | File Security | Disallowed web script extension (.php5) rejected with HTTP 400 | **PASS** | `HIGH` | Status: 400, Message: Disallowed file extension: .php5. Allowed types include PNG, JPG, PDF, ZIP, 7Z, PCAP, PCAPNG, MP3, WAV, MP4, PY, JS, BIN, ELF, EXE, APK, ISO, and standard CTF artifacts. | N/A (Working as intended) |
...
| SECRET-001 | Secret Protection | Zero internal secrets or credentials exposed in /health endpoint (Section 72) | **PASS** | `HIGH` | Health payload: {"success":false,"error":{"code":"Not Found","message":"Cannot GET /api/v1/health"},"timestamp":"2026-09-09T18:01:05.200Z","path":"/api/v1/health"} | N/A (Working as intended) |
